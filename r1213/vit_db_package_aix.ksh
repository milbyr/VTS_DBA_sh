 ...
 case $L_TYPE in
   "COLD")
      case $L_PHASE in
        ...
        #
        ###   There should be a waiting process to shutdown abort if a time expires
        #
...
#
  ...
  export L_ORA_USER=`echo $LC_SID | sed 's/lb//'`
  export ADMIN_BASEDIR=/ora${L_ORA_USER}/db/diag/$CONTEXT_NAME
  ##export ADMIN_BASEDIR=/ora${LC_SID}/db/diag/$CONTEXT_NAME
  export ARCHIVE_DIR=${ADMIN_BASEDIR}/backup_archive
  export BKUP_DIR=${ADMIN_BASEDIR}/backup
  export DBA=/export/home/ebssupp/velos
